...
#ifndef GOOGLE_PROTOBUF_INCLUDED_req_2fQuoteSubscribeTickReq_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_req_2fQuoteSubscribeTickReq_2eproto_2epb_2eh
...
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_req_2fQuoteSubscribeTickReq_2eproto;
namespace Quote {
...
class SubscribeTickReq final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Quote.SubscribeTickReq) */ {
 public:
  inline SubscribeTickReq() : SubscribeTickReq(nullptr) {}
  ~SubscribeTickReq() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR SubscribeTickReq(::google::protobuf::internal::ConstantInitialized);

  inline SubscribeTickReq(const SubscribeTickReq& from)
      : SubscribeTickReq(nullptr, from) {}
  ...
  SubscribeTickReq* New(::google::protobuf::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit SubscribeTickReq(::google::protobuf::Arena* arena);
  SubscribeTickReq(::google::protobuf::Arena* arena, const SubscribeTickReq& from);
  public:
...
inline ::google::protobuf::RepeatedPtrField<::Stock>* SubscribeTickReq::mutable_stocklist()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::Stock* SubscribeTickReq::add_stocklist() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::Stock* _add = _internal_mutable_stocklist()->Add();
  // @@protoc_insertion_point(field_add:Quote.SubscribeTickReq.stockList)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::Stock>& SubscribeTickReq::stocklist() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
SubscribeTickReq::_internal_stocklist() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.stocklist_;
}
inline ::google::protobuf::RepeatedPtrField<::Stock>*
SubscribeTickReq::_internal_mutable_stocklist() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.stocklist_;
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_req_2fQuoteSubscribeTickReq_2eproto_2epb_2eh
